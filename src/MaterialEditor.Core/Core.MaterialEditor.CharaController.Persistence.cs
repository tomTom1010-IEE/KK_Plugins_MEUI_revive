    ...
    public partial class MaterialEditorCharaController
    {
        ...
        protected override void OnCoordinateBeingSaved(ChaFileCoordinate coordinate)
        {
            ...
            else
            {
                ...
                data.data.Add(nameof(RendererPropertyList), coordinateRendererPropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateRendererPropertyList) : null);

                data.data.Add(nameof(ProjectorPropertyList), coordinateProjectorPropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateProjectorPropertyList) : null);

                data.data.Add(nameof(MaterialNamePropertyList), coordinateMaterialNamePropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialNamePropertyList) : null);

                data.data.Add(nameof(MaterialFloatPropertyList), coordinateMaterialFloatPropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialFloatPropertyList) : null);

                data.data.Add(nameof(MaterialKeywordPropertyList), coordinateMaterialKeywordPropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialKeywordPropertyList) : null);

                data.data.Add(nameof(MaterialColorPropertyList), coordinateMaterialColorPropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialColorPropertyList) : null);

                data.data.Add(nameof(MaterialVectorPropertyList), coordinateMaterialVectorPropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialVectorPropertyList) : null);

                data.data.Add(nameof(MaterialTexturePropertyList), coordinateMaterialTexturePropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialTexturePropertyList) : null);

                data.data.Add(nameof(MaterialCubemapPropertyList), coordinateMaterialCubemapPropertyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialCubemapPropertyList) : null);

                data.data.Add(nameof(MaterialShaderList), coordinateMaterialShaderList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialShaderList) : null);

                data.data.Add(nameof(MaterialCopyList), coordinateMaterialCopyList.Count > 0 ? MessagePackSerializer.Serialize(coordinateMaterialCopyList) : null);
